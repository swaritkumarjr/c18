...
function setup() {
  ...
  invisibleGround = createSprite(windowWidth/2,windowHeight-10,400,10);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if((touches.length > 0 || keyDown("SPACE")) && trex.y  >= windowHeight-120) {
      trex.velocityY = -10;
      touches = [];
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(windowWidth,windowHeight-300,40,10);
